...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA0-WKUP     ------> ADC1_IN0
    */
    HAL_GPIO_DeInit(SU_SEVIYE_GPIO_Port, SU_SEVIYE_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA4     ------> ADC2_IN4
    */
    HAL_GPIO_DeInit(EC_SENSOR_GPIO_Port, EC_SENSOR_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(BH1750_1_SCL_GPIO_Port, BH1750_1_SCL_Pin);

    HAL_GPIO_DeInit(BH1750_1_SDA_GPIO_Port, BH1750_1_SDA_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB11     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(BH1750_2_SCL_GPIO_Port, BH1750_2_SCL_Pin);

    HAL_GPIO_DeInit(BH1750_2_SDA_GPIO_Port, BH1750_2_SDA_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(BMP180_SCL_GPIO_Port, BMP180_SCL_Pin);
